<template>
  <div class="home">
    <el-container>
      ...
      <el-aside width="auto">
        <div class="logo"></div>
        <el-menu class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" :unique-opened='true' :collapse='iscollapse' :router='true'>
          <!-- 用户管理 -->
          <el-submenu index="1">
            <template slot="title">
